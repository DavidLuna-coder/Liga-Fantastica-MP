...
void listarPlantillas(){
	...
	for(i=0;i<usuarios[usuarioActual].numeroPlantillas;i++){
		printf("%i-%i-%s-%i-%i\n",i+1,usuarios[usuarioActual].plantillas[i].idPlantilla,usuarios[usuarioActual].plantillas[i].nombre, usuarios[usuarioActual].plantillas[i].presupuestoDisponible, usuarios[usuarioActual].plantillas[i].puntuacion);
	}
